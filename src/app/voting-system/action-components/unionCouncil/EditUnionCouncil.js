...
const EditUnionCouncil= () => {
    ...
    const onSubmit= async e =>{
        e.preventDefault();
        await axios.put(`http://127.0.0.1:8090/unionCouncils/${id}`, unionCouncil)
    ...
    return(
        <div className="container">
            <div className="w-75 mx-auto shadow p-5">
                <h2 className="text-center mb-4"> Edit Union Council </h2>
...
export default EditUnionCouncil;