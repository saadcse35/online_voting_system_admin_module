        ...
        <ul className="nav">
          ...
          <li className={ this.isPathActive('/basic-ui') ? 'nav-item active' : 'nav-item' }>
            <div className={ this.state.basicUiMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('basicUiMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title">Basic Forms</span>
              <i className="menu-arrow"></i>
            </div>
            <Collapse in={ this.state.basicUiMenuOpen }>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={ this.isPathActive('/division') ? 'nav-link' +
                    ' active' : 'nav-link' } to="/division">Division</Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/district') ? 'nav-link' +
                    ' active' : 'nav-link' } to="/district">District</Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/upazila') ? 'nav-link' +
                    ' active' : 'nav-link' } to="/upazila">Upazila</Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/unionCouncil') ? 'nav-link' +
                    ' active' : 'nav-link' } to="/unionCouncil">Union Council</Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/seatNames') ? 'nav-link' +
                    ' active' : 'nav-link' } to="/seatNames">Seat Names</Link></li>
              </ul>
            </Collapse>
          </li>
          <li className={ this.isPathActive('/party') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/party">
              <i className="mdi mdi-format-list-bulleted menu-icon"></i>
              {/*<span className="menu-title">Form Elements</span>*/}
              <span className="menu-title">Party </span>
            </Link>
          </li>
          <li className={ this.isPathActive('/voteInfo') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/voteInfo">
              <i className="mdi mdi-table-large menu-icon"></i>
              {/*<span className="menu-title">Tables</span>*/}
              <span className="menu-title">Vote Info</span>
            </Link>
          </li>
          <li className={ this.isPathActive('/candidate') ? 'nav-item active' : 'nav-item' }>
          ...
          <li className={ this.isPathActive('/voter') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/voter">
              {/*<i className="mdi mdi-chart-line menu-icon"></i>*/}
              {/*<span className="menu-title">Charts</span>*/}
              <i className="mdi mdi-nfc-search-variant menu-icon"></i>
              <span className="menu-title">Voter List</span>
            </Link>
          </li>

          <li className={ this.isPathActive('/voteWiseVoter') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/voteWiseVoter">
              {/*<i className="mdi mdi-chart-line menu-icon"></i>*/}
              {/*<span className="menu-title">Charts</span>*/}
              <i className="mdi mdi-bookmark-multiple menu-icon"></i>
              <span className="menu-title">Vote Wise Voter List</span>
            </Link>
          </li>

          <li className={ this.isPathActive('/voteCalculation') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/voteCalculation">
              {/*<i className="mdi mdi-chart-line menu-icon"></i>*/}
              {/*<span className="menu-title">Charts</span>*/}
              <i className="mdi mdi-file-outline menu-icon"></i>
              <span className="menu-title">Vote Calculation</span>
            </Link>
          </li>
